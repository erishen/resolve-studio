  ...
  ctx.tools.register({
    ...
    parameters: {
      ...
      properties: {
        ...
        ignore: {
          type: 'array',
          description: 'Optional extra directory names to skip (node_modules/.git/.venv/caches are skipped by default).',
        },
        maxFiles: {
          type: 'number',
...
export const toolAnalyzeDir = definePlugin(registerAnalyzeDir, 'tool-analyze-dir', ['tools', 'fsRoots'])
